...
Игровой стенд ещё не создавался и не запускался; строки «не проверено» ниже не являются
...
Они описывают будущую настройку карты, а не созданный стенд.
...
Будущий источник должен лежать так:
