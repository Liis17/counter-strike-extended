...
Карта, компиляторы, install-скрипт и C++-реализация пока не создавались.
...
Следующий практический шаг — двухклиентский стенд уровня 1. Fork ReGameDLL и exception из
