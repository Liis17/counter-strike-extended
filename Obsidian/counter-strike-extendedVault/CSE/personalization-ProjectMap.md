...
Main.cpp
  └─ UI_Personalization_Menu
       ├─ CseProgression.txt::CseSkins ──> CSESkinListModel ──> cse_skin
...
|----------------|-----------------|
| Добавить оружейный скин | `src/cse/cstrike/scripts/CseProgression.txt`; модель — через `CseSkinRecipes.txt` |
