...
- Собственный viewmodel, player model и world/dropped model разрешаются клиентом по локальному loadout;
  серверу не передаётся отдельный сетевой индекс косметической модели.
